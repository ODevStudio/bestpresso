...
export async function syncHistory(read: (offset: number) => Promise<PaginatedShots>, previous: HistoryCache | null, source: string, timezone: string, now: Date, force = false): Promise<HistoryCache> {
