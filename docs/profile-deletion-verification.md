...
- A separate Delete profile action appears in the detail body only for known `isDefault: false` records. This includes created profiles, imported profiles and user-saved copies. Missing provenance and bundled defaults are protected.
